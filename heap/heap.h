...
/**
 * @brief Gets the element with the highest priority (smallest value in the priority array) from the Heap data structure.
...
/**
 * @brief Removes the element with the highest priority from the Heap data structure.
 * @param h A pointer to the Heap data structure to remove the element from.
 * @return The element with the highest priority that was removed from the Heap data structure.
 */
